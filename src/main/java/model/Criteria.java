...
public class Criteria {
    ...
    public Criteria(int criteriaId, String courseCode, int quiz1, int quiz2, int quiz3, int quiz4, int quiz5, int assignment1, int assignment2, int assignment3, int midExam, int finalExam) {
